...
export default function Stats() {
  return (
    <div className="grid grid-cols-12 sm:grid-flow-col p-5 h-auto sm:h-[100px] bg-wash shadow-2xl  overflow-hidden  rounded-md">
      <div className=" col-span-6 sm:col-span-3 text-center p-2 font-bold">
        <div className="flex justify-center">
          <div className="px-2">
            <svg
              ...
              width={25}
            >
              <path d="M30 30h-8V4h8zm-6-2h4V6h-4z" fill="currentColor"></path>
              <path
                d="M20 30h-8V12h8zm-6-2h4V14h-4z"
                fill="currentColor"
              ></path>
      ...
      <div className="col-span-6 sm:col-span-3 text-center p-2 font-bold">
        <div className="flex justify-center">
          <p className=" text-xl font-bold">ASP.Net</p>
        </div>
        <p className=" text-sm text-gray-400">Mostly Use Backend</p>
      </div>
      <div className="col-span-6 sm:col-span-3 text-center p-2 font-bold">
        <div className="flex justify-center">
          <div className="px-2">
        ...
        <p className=" text-sm text-gray-400">Mostly Use Frontend</p>
      </div>
    </div>
  )
}
